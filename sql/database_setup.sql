...
INSERT INTO timeslots (name, start_time, end_time) VALUES
    ('Timeslot 1', '09:00', '09:55'),
    ('Timeslot 2', '10:00', '10:40'),
    ('Timeslot 3', '10:45', '11:25'),
    ('Timeslot 4', '11:30', '12:10'),
    ('Timeslot 5', '12:15', '12:55'),
    ('Timeslot 6', '13:00', '13:40'),
    ('Timeslot 7', '13:45', '14:25'),
    ('Timeslot 8', '14:30', '15:10'),
    ('Timeslot 9', '15:15', '15:55'),
    ('Timeslot 10', '16:00', '16:40'),
    ('Timeslot 11', '16:45', '17:25'),
    ('Timeslot 12', '17:30', '18:10');
...
CREATE TABLE schedule (
    ...
    start_timeslot_id INT NOT NULL REFERENCES timeslots(id) ON DELETE CASCADE,
    end_timeslot_id INT NOT NULL REFERENCES timeslots(id) ON DELETE CASCADE,
