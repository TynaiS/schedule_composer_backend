...
public class ApiConstants {
    ...
    public static final String COURSE_GROUP_TEACHER_API = BASE_API + "/group_course_teacher";
    ...
    public static final String SCHEDULE_LUNCH_API = BASE_API + "/schedule_lunches";
