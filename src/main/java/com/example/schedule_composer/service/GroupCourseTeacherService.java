...
@Service
public class GroupCourseTeacherService implements CrudService<GroupCourseTeacherDTOGet, GroupCourseTeacherDTOPost, GroupCourseTeacherDTOPatch, GroupCourseTeacher, Long> {
    ...
    @Autowired
    public GroupCourseTeacherService(GroupCourseTeacherRepository groupCourseTeacherRepository,GroupCourseTeacherMapper groupCourseTeacherMapper){
