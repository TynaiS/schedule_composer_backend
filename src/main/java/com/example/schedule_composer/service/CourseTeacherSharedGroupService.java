...
@Service
public class CourseTeacherSharedGroupService implements CrudService<CourseTeacherSharedGroupDTOGet, CourseTeacherSharedGroupDTOPost, CourseTeacherSharedGroupDTOPatch, CourseTeacherSharedGroup, Long> {
    ...
    @Autowired
    public CourseTeacherSharedGroupService(CourseTeacherSharedGroupRepository courseTeacherSharedGroupRepository,CourseTeacherSharedGroupMapper courseTeacherSharedGroupMapper){
